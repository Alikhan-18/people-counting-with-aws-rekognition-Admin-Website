...
print(jsonObj['Stacks'][0]['Outputs'][0]['OutputKey'] + \" : \" + jsonObj['Stacks'][0]['Outputs'][0]['OutputValue'])
print(jsonObj['Stacks'][0]['Outputs'][1]['OutputKey'] + \" : \" + jsonObj['Stacks'][0]['Outputs'][1]['OutputValue'])
"
